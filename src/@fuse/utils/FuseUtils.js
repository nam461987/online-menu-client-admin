...
class FuseUtils {
    ...
    static setRoutes(config, defaultAuth) {
        ...
        routes = routes.map((route) => {
            ...
            let authByStr = config.authByStr ? config.authByStr : "";
            authByStr = route.authByStr
                ? authByStr + route.authByStr
                : authByStr;
        ...
        for (let i = 0; i < navigationItems.length; i += 1) {
            ...
            if (navItem.type === "item") {
                flatNavigation.push({
                    ...
                    authByStr: navItem.authByStr || null,
                });
            }
    ...
    static hasPermission(authByStr, UserPermissions) {
        /**
         * If auth array is not defined
         * Pass and allow
         */
        if (authByStr === null || authByStr === undefined) {
            // console.info("auth is null || undefined:", authArr);
            return true;
        }
        if (authByStr.length === 0) {
            /**
        ...
        /*
            ...
            */
        return UserPermissions.includes(authByStr);
    }
