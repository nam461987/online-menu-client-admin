...
import { getGroups, selectGroups, removeGroups } from "../store/groupsSlice";
import obj from "./configs/config";
import scope from "../reducerConfig";

function Groups() {
    const paging = useSelector((state) => state[scope.reducerName].groups.page);
...
export default withReducer(
    "common",
    commonReducer
)(withReducer(scope.reducerName, reducer)(Groups));
