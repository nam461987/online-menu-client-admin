...
import TableHeader from "app/main/shared/components/TableHeader";
...
function ListTable(props) {
    ...
    useEffect(() => {
        dispatch(
            getItems({ menuId, pageIndex: page, pageSize: rowsPerPage })
    ...
    function handleClick(item) {
        props.history.push(
            `${obj.baseRoute}${menuId}/${item[obj.primaryKey]}/${slugify(
                item[obj.urlName],
