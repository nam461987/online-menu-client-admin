...
const getUserPermissions = (state) => state.auth.user.permissions;
...
export const selectNavigation = createSelector(
    ...
    (navigation, language, userRole, UserPermissions) => {
        ...
        return setTranslationValues(
            _.merge(
                ...
                FuseUtils.filterRecursive(navigation, (item) =>
                    FuseUtils.hasPermission(item.authByStr, UserPermissions)
                )
            )
        );
    }
